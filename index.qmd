...
The $D_{KL}$ quantifies the information gained by discovering that the Universe is described by a non-trivial topology. For some "data" $a_{lm}, $D_{KL}$ favors nontrivial topology if it is bigger than 1. 
